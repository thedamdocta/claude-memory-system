...
echo "  Just start Claude Code in a new directory and tell it to set up a new project."
echo "  The _MASTER.md has the full template — Claude knows how to scaffold."
echo ""
